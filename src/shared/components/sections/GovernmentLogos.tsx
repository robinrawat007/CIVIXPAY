    ...
    return (
        <div className="relative overflow-hidden py-12">
            ...
            <div className="flex relative items-center">
                {/* Gradient Masks */}
                <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#fafdfb] to-transparent z-10"></div>
                <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#fafdfb] to-transparent z-10"></div>
                ...
                >
                    {[...logos, ...logos].map((logo, i) => (
                        <img
                            ...
                            src={logo}
                            alt="Gov Logo"
                            className="h-10 w-auto opacity-30 hover:opacity-100 transition-opacity Filter grayscale hover:grayscale-0"
                        />
                    ))}
                </motion.div>
            </div>
