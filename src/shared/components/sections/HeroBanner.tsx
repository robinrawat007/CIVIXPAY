                ...
                <div className="flex-1 text-center lg:text-left">
                    ...
                    <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-6">
                        <button
                            ...
                            className="w-full sm:w-auto bg-gradient-to-br from-emerald-600 to-green-700 text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl font-black uppercase tracking-[0.12em] sm:tracking-widest text-xs sm:text-sm shadow-2xl shadow-emerald-500/30 transition-all hover:shadow-emerald-500/50 hover:scale-[1.02]"
                        >
                            Get Started
                        </button>
                    ...
                    <div className="relative z-10 p-2 sm:p-4 bg-white/40 backdrop-blur-lg rounded-[24px] sm:rounded-[40px] border border-white/60 shadow-3xl">
                        <div className="bg-gray-900 aspect-video rounded-[18px] sm:rounded-[32px] flex items-center justify-center overflow-hidden shadow-2xl relative group">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <span className="px-6 py-3 bg-emerald-800/95 backdrop-blur-md text-white rounded-2xl font-black uppercase tracking-tighter text-sm shadow-2xl shadow-emerald-500/40 transition-transform group-hover:scale-105">
                                    Systems Operational
                                </span>
                            </div>
                        </div>
